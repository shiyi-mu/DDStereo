...
class StereoLightDETROoDOnehead(nn.Module):
    """ This is the StereoLightDETROoD module that performs monocualr 3D object detection """
    def __init__(self, backbone, stereo_transformer, depth_predictor, num_classes, num_queries, num_feature_levels,
        ...
        num_pred = (stereo_transformer.decoder.num_layers + 1)
        if with_box_refine:
...
def build_lightstereoOodOnehead(cfg):
    # backbone
    ...
    model = StereoLightDETROoDOnehead(
        backbone,
