        ...
        if not self.cat_left:   
            ...
            self.depth_reason = nn.Sequential(
                ...
                MobileV2Residual(3 * input_features, 
                                256, stride=1, expanse_ratio=self.expanse_ratio)
            )
        else:
    ...
    def forward(self, feature_stereo, mask, pos, targets=None):
        ...
        if self.training :
            ...
            for  batch_id in range(batch_size_half):
                ...
                f_left_i_s32 = feature_stereo[3][batch_id].unsqueeze(0)
                f_right_i_s32 = feature_stereo[3][batch_id+batch_size_half].unsqueeze(0)
                if flip_flag or switch_flag:
                    ...
                    gwc_volume_list32.append(correlation_volume_flip(f_left_i_s32, f_right_i_s32, 192 // 16))
                else:
                    ...
                    gwc_volume_list32.append(correlation_volume(f_left_i_s32, f_right_i_s32, 192 // 16))
            ...
            gwc_volume_s32 = torch.cat(gwc_volume_list32, 0)
        else:         
            ...
            gwc_volume_s16 = correlation_volume(feature_stereo[2][:batch_size_half], 
                                               ...
                                               192 // 16)
            gwc_volume_s32 = correlation_volume(feature_stereo[3][:batch_size_half], 
                                               feature_stereo[3][batch_size_half:], 
                                               192 // 16)
        features_left = []
        ...
        features_for_decoder = [gwc_volume_s4, gwc_volume_s8, gwc_volume_s16, gwc_volume_s32]
        ...
        return depth_logits, depth_embed, weighted_depth, depth_pos_embed_ip, features_for_decoder, pred_disp, feature_depth_dead
