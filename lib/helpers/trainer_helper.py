...
class Trainer(object):
    ...
    def train_one_epoch(self, epoch):
        ...
        for batch_idx, (inputs, calibs, targets, info) in enumerate(self.train_loader):
            ...
            # print("self.detr_loss.weight_dict", self.detr_loss.weight_dict)
            ...
            for k in detr_losses_dict.keys():
                if k in weight_dict:
                    ...
                    pass
                    # print("*"*10, "Key not found in weight_dict", k)
            detr_losses_dict_log["loss_detr"] = detr_losses_log
            # print("weight_dict", weight_dict)
            # print("detr_losses_dict_log", detr_losses_dict_log.keys())
            flags = [True] * 5
            if batch_idx % 30 == 0:
                print("----", batch_idx, "----")
